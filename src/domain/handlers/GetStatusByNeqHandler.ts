...
export class GetStatusByNeqHandler implements ICommandHandler<string, Promise<BusinessStatusModel>> {
    ...
    public async Handle(neqId: string): Promise<BusinessStatusModel> {
